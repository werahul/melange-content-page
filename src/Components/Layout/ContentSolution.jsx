            ...
            <div className=" relative">
                <div className="lg:flex justify-center items-start lg:space-x-[60px]">
                    ...
                    <div className="lg:-mt-0 mt-3">
                        <div className=""><span className="multiverse-text lg:text-5xl text-3xl font-bold font-nunito lg:leading-[56px]">Content Solutions</span><span className="text-zinc-900 lg:text-5xl text-3xl font-bold font-nunito lg:leading-[56px]"> </span><span className="text-zinc-900 lg:text-5xl text-3xl font-semibold font-nunito lg:leading-[56px]">that Drive Results</span></div>
